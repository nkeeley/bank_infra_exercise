...
I made most commits manually, leveraged branches for critical milestones, and reviewed every AI suggestion. The full prompt-by-prompt log is in [AI_USAGE_LOG.md](AI_USAGE_LOG.md).

### Early design work

Before writing code, I sketched a rough database schema to define entity relationships:

![Database schema sketch](images/db_schema.jpg)
...
![Ledger-based transfer design](images/ledger_based_transfers.jpg)
